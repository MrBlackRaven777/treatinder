...
public class PaginationLinks {
  ...
  private LinkNullable previous = null;

  @SerializedName("next")
  private LinkNullable next = null;

  public PaginationLinks previous(LinkNullable previous) {
  ...
  **/
  @Schema(description = "")
  public LinkNullable getPrevious() {
    return previous;
  }

  public void setPrevious(LinkNullable previous) {
    this.previous = previous;
  }

  public PaginationLinks next(LinkNullable next) {
    this.next = next;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public LinkNullable getNext() {
    return next;
  }

  public void setNext(LinkNullable next) {
    this.next = next;
  }
